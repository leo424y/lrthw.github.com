...
puts "Your first variable is: #{sex}#{first}"
puts "Your second variable is: #{sex}#{second}"
puts "Your third variable is: #{sex}#{third}"
puts "Your fourth variable is: #{sex}#{fourth}"

